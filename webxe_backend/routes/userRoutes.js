...
import { getProfile, updateProfile, getVehicleAvailabilityAlert, sendVehicleAvailabilityAlert } from '../controllers/userController.js';
...
router.get('/vehicle-availability-alert', verifyToken, getVehicleAvailabilityAlert);
